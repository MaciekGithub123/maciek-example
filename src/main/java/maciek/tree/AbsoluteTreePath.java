...
/**
 * A location in the tree determined by a tree path from the root.
 */
public class AbsoluteTreePath<N extends TreeNode<N, S>, S extends TreeNodeSemantics<S>> extends TreePath
		implements TreeLocation<N, S> {
